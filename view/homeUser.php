...
<div id="lkjlh">
  ...
  <div class="d-flex justify-content-center align-items-center">
    <form action="index.php?action=search" method="post" id="booking" class="ajax-search-form container rounded-5 row g-3 needs-validation p-4 mt-3 border border-black">
      <div class="col-md-3">
      ...
      <div class="container d-flex ">
          ...
          <div>
            ...
            <ul class="d-flex flex-column" id="company_filter" name="company_filter">
              <?php foreach ($entreprisesDATA as $key => $comName) { ?>
                <li class="mt-3">
                  <input type="checkbox" class="form-check-input company-name" value="<?= $comName->getIdEntreprise(); ?>" id="<?= "company-" . ($key + 1) ?>">
        ...
        <div id="bus_disponibles" class="w-70 mx-auto">
          <?php foreach ($horaireDATA as $Horaire) : ?>
            <div class="group mt-4 relative overflow-hidden bg-white rounded-3xl p-4 shadow border-2 hasLabelQualite">
              <div class="grid grid-cols-4 gap-6">
                <div class="col-span-3 border-dashed ltr:border-r-2 rtl:border-l-2 ltr:pr-4 rtl:pl-4">
                  <div class="flex justify-between items-center rounded-full py-1 ltr:pr-1 rtl:pr-4 ltr:pl-4 rtl:pl-1 bg-gold-500 text-black">
                    <div class="flex items-center"><span class="text-primary transition-opacity duration-200 opacity-0 group-hover:opacity-100 text-xs">●
                      </span>
                      <div class="flex items-center gap-8 ltr:-translate-x-2 rtl:translate-x-2 ltr:group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition duration-100 ease-in-out">
                  ...
                  <div class="grid grid-cols-3 items-center gap-10 mt-6"><img data-src="assets/imgs/<?php echo $Horaire->getCompanyImage(); ?>" alt="" class="group-hover:grayscale-0 grayscale ls-is-cached lazyloaded" src="assets/imgs/<?php echo $Horaire->getCompanyImage(); ?>">
                    <div class="col-span-2">
                      <div class="flex justify-center items-baseline col-span-2 text-black">
                        <div x-data="{ tooltipDepartAdress: false }" class="flex flex-col items-center">
                          ...
                          <div x-on:mouseover="tooltipDepartAdress = true" x-on:mouseleave="tooltipDepartAdress = false" class="text-xs font-medium uppercase flex cursor-help flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
                              <g fill="none" stroke="#ff6900" stroke-width="2">
                                ...
                                <path stroke-linecap="round" d="M20.96 15.5c.666.602 1.04 1.282 1.04 2c0 2.485-4.477 4.5-10 4.5S2 19.985 2 17.5c0-.718.374-1.398 1.04-2">
                                </path>
                              </g>
                            </svg>
                            &nbsp;<?php echo $Horaire->getVilleDepart(); ?>
                            <div x-show.transition.origin.top="tooltipDepartAdress" class="relative -top-4 rtl:left-36 ltr:left-0" style="display: none;">
                              <div class="normal-case	 absolute top-0 z-10 w-52 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-primary rounded-lg shadow-lg">
                                ...
                                80000
                              </div> <svg width="8" height="8" class="absolute z-10 w-6 h-6 text-primary transform ltr:-translate-x-12 rtl:-translate-x-32 -translate-y-3 fill-current stroke-current">
                        ...
                        <div x-data="{ tooltipArriveeAdress: false }" class="flex flex-col items-center">
                          ...
                          <div x-on:mouseover="tooltipArriveeAdress = true" x-on:mouseleave="tooltipArriveeAdress = false" class="text-xs font-medium uppercase flex cursor-help flex items-center">
                            ...
                            <div x-show.transition.origin.top="tooltipArriveeAdress" class="relative -top-4 rtl:left-36 ltr:left-0" style="display: none;">
                              ...
                              <svg width="8" height="8" class="absolute z-10 w-6 h-6 text-primary transform ltr:-translate-x-12 rtl:-translate-x-32 -translate-y-3 fill-current stroke-current">
                                <rect x="12" y="-10" width="8" height="8" transform="rotate(45)">
                                </rect>
                              </svg>
                            </div>
...
<script>
  ...
  function updateResults(minPrice, maxPrice, selectedCompanies) {
    ...
    $.ajax({
      type: 'POST',
      url: 'index.php?action=filtre', // Changez ceci avec le chemin de votre script de recherche
      data: {
        minPrice: minPrice,
        maxPrice: maxPrice,
