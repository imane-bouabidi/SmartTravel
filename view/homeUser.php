        ...
        <form action="index.php?action=search" method="post" id="booking"
            ...
            <div class="col-md-3">
                <div class="form-outline" data-mdb-input-init>
                    ...
                    <input name="date" type="date" class="form-control" id="validationCustom01"
            ...
            <div class="col-md-3">
                <div class="form-outline" data-mdb-input-init>
                    ...
                    <input name="NumCustom" type="number" class="form-control" id="validationCustom02"
                        value="<?= $_POST["NumCustom"] ?? 1; ?>" required>
                </div>
            </div>
